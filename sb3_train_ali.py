...
def main(args):
    ...
    model = SAC("MlpPolicy", train_env, learning_rate= 1e-3, gamma=0.99, verbose = args.verbose-1)
    ...
    eval_callback = EvalCallback(
        ...
        log_path='logs/',   # Where to log results (if desired)
        best_model_save_path='logs/', # Where to save the best model (if desired)
